...
<div class="modal fade" id="modalProfile" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title fs-5" id="exampleModalLabel"><strong>Data Penitip</strong></h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
             <div class="mb-3">
                    <strong>Nama Pengguna: </strong><span id="namaPenitip1"></span>
                </div>
                <div class="mb-3">
                    <strong>Saldo: </strong><span id="saldo1"></span>
                </div>
                <div class="mb-3">
                    <strong>Jumlah Poin: </strong><span id="poin1"></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card bg-subtle shadow-lg" style="border-radius: 0.5rem;">
            <div class="card-body p-4">
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-md-6 mb-3"> -->
                        <div class="d-flex align-items-center">
                           <button type="button" class="btn btn-detail btn-outline-primary"
                           data-bs-toggle="modal" data-bs-target="#modalProfile"  onClick="getData()"> Klik </button>
                        </div>
                    <!-- </div> -->
                </div>
            </div>
    ...
    document.querySelectorAll(".btn-detail").forEach(link => {
                    link.addEventListener("click", function () {
                        idPenitip = this.getAttribute("data-id");
                        const namaPenitip = this.getAttribute("data-namaPenitip");
    ...
    /////////////////////buat logout///////////////////////
        ...
        .then(data => {
            if (data.status) {
                ...
                // Update data dan hilangkan "Loading..."
                document.getElementById('namaPenitip1').textContent = user.namaPenitip ?? '-';
                document.getElementById('poin1').textContent = user.poin ? `${user.poin} Poin` : '0 Poin';
                document.getElementById('saldo1').textContent = user.dompet && user.dompet.saldo != null ? ubahFormat(user.dompet.saldo) : '-';
