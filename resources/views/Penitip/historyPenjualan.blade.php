...
<div class="container mb-4 mt-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <input type="text" id="searchInput" class="form-control" placeholder="Cari barang, kategori, harga, dll...">
        </div>
    </div>
</div>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    function fetchBarang(idPenitip){
        fetch(`http://localhost:8000/api/penitip/history`, {
            method: "GET",
            headers: {
                "Authorization": `Bearer ${token}`,
                'Accept': 'application/json',
    ...
    document.addEventListener("click", function (e) {
        ...
        if (e.target.classList.contains("btn-detail")) {
            ...
            document.getElementById("tanggalPenitipan").textContent = formatTanggal(button.getAttribute("data-tanggalPenitipan"));
            document.getElementById("tanggalPenitipanSelesai").textContent = formatTanggal(button.getAttribute("data-tanggalPenitipanSelesai"));
            document.getElementById("statusBarang").textContent = button.getAttribute("data-statusBarang");
            document.getElementById("tanggalTerjual").textContent = formatTanggal(button.getAttribute("data-tanggalTerjual"));
